...
Variants {
    ...
    delegate: Component {
        PanelWindow {
            ...
            Process {
                id: wsDaemon
                command: ["bash", "-c", "~/.config/niri/scripts/quickshell/workspaces.sh"]
                running: true
            }
            ...
            Process { id: kbWaiter; command: ["bash", "-c", "~/.config/niri/scripts/quickshell/watchers/kb_wait.sh"]; onExited: { kbPoller.running = false; kbPoller.running = true; } }
            ...
            Process { id: audioWaiter; command: ["bash", "-c", "~/.config/niri/scripts/quickshell/watchers/audio_wait.sh"]; onExited: { audioPoller.running = false; audioPoller.running = true; } }
            ...
            Process { id: networkWaiter; command: ["bash", "-c", "~/.config/niri/scripts/quickshell/watchers/network_wait.sh"]; onExited: { networkPoller.running = false; networkPoller.running = true; } }
            ...
            Process { id: btWaiter; command: ["bash", "-c", "~/.config/niri/scripts/quickshell/watchers/bt_wait.sh"]; onExited: { btPoller.running = false; btPoller.running = true; } }
            ...
            Process { id: batteryWaiter; command: ["bash", "-c", "~/.config/niri/scripts/quickshell/watchers/battery_wait.sh"]; onExited: { batteryPoller.running = false; batteryPoller.running = true; } }
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/niri/scripts/qs_manager.sh " + wsName])
                                }
                            }
                        }
                    }
