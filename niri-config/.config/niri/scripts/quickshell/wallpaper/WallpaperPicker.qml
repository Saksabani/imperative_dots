...
Item {
    ...
    Process {
        id: monitorProc
        command: ["sh", "-c", "export PATH=$PATH:/usr/bin:/usr/local/bin:/run/current-system/sw/bin && niri msg --json outputs"]
        running: false
    ...
    function loadMonitors() {
        console.log("[MonitorSync] Starting native niri msg process...");
