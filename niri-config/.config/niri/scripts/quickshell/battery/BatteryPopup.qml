                ...
                Item {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                model: ListModel {
                                    ListElement { cmd: "bash ~/.config/niri/scripts/lock.sh"; icon: ""; baseColor: "mauve"; weight: 1.0 }
                                    ListElement { cmd: "bash ~/.config/niri/scripts/lock.sh & systemctl suspend"; icon: "ᶻ 𝗓 𝗓"; baseColor: "blue"; weight: 1.0 }
