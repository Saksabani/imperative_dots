    ...
    RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            let cmd = "tmp=$(mktemp) && curl -fsSL https://raw.githubusercontent.com/ilyamiro/imperative-dots/master/install.sh -o \"$tmp\" && if command -v kitty >/dev/null 2>&1; then kitty --hold bash \"$tmp\"; else ${TERM:-xterm} -hold -e bash \"$tmp\"; fi";
        ...
        Item {
            ...
            Item {
                ...
                ListModel {
                    id: systemDataModel
                    ListElement { pkg: "Niri"; role: "Wayland Compositor"; icon: "󱗃"; clr: "blue"; link: "https://github.com/YaLTeR/niri" }
